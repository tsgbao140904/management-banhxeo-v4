...
<div class="sidebar">
    ...
    <a class="nav-link active" href="${pageContext.request.contextPath}/admin/order-management" aria-current="page"><i class="fas fa-shopping-cart me-2"></i> Quản Lý Đơn Hàng</a>
